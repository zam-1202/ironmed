        ...
        $.ajax({
            ...
            success: (response) => {
                if (response.length === 0) {
                    ...
                    if (product_barcode == "" || product_name == "" || product_category == "" || lot_num == "" || buying_price == "" || selling_price == "" || manufature_date == "" || expiraton_date == "" || quantity == "" || type == null || status == null || location == "") {
                        Swal.fire({
                            position: 'center',
                            icon: 'warning',
