                ...
                <div class="user__form-wrapper">
                    <form class="login__form" action="">
                        <div class="col-md-12" style="margin-bottom: 20px;">
                            ...
                            <input type="password" class="form-control" id="txt_newforgetpassword" maxlength="128" onkeyup="ChangePassword.validateNewForgetPass()" required/><span id="forgetpass"></span>
                        </div>

                        <div class="col-md-12">
                            <label for="confirmforgetPassword" class="form-label">Confirm New Password</label>
                            <input type="password" class="form-control" id="txt_confirmforgetPassword" maxlength="128" name="txt_oldpassword" onkeyup="ChangePassword.validateConfirmForgetPassword()"><span id="confirmforgetpass"></span>
                        </div>
