            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="user__form-wrapper">
                        <h2 class="section__sub-title" id="lbl_title">Create Accountavility</h2>
                        <form class="row g-3">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <span class="required" id="passwordRequired" style="color:red"> *</span>
                            ...
                            <div class="col-md-12">
                                ...
                                <span class="required" id="confirmPasswordRequired" style="color:red"> *</span>
                                <div style="position: relative;">
